...
// ignore: unused_element
  NotAlphaNum<T> notAlphaNum<T>({@required T failedValue}) {
    return NotAlphaNum<T>(
      failedValue: failedValue,
    );
  }
}
...
/// @nodoc
abstract class $NotAlphaNumCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $NotAlphaNumCopyWith(
          NotAlphaNum<T> value, $Res Function(NotAlphaNum<T>) then) =
      _$NotAlphaNumCopyWithImpl<T, $Res>;
  @override
  $Res call({T failedValue});
}

/// @nodoc
class _$NotAlphaNumCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $NotAlphaNumCopyWith<T, $Res> {
  _$NotAlphaNumCopyWithImpl(
      NotAlphaNum<T> _value, $Res Function(NotAlphaNum<T>) _then)
      : super(_value, (v) => _then(v as NotAlphaNum<T>));

  @override
  NotAlphaNum<T> get _value => super._value as NotAlphaNum<T>;

  @override
  $Res call({
    Object failedValue = freezed,
  }) {
    return _then(NotAlphaNum<T>(
      failedValue:
          failedValue == freezed ? _value.failedValue : failedValue as T,
    ));
  }
...
/// @nodoc
class _$NotAlphaNum<T> with DiagnosticableTreeMixin implements NotAlphaNum<T> {
  const _$NotAlphaNum({@required this.failedValue})
      : assert(failedValue != null);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ValueFailure<$T>.notAlphaNum(failedValue: $failedValue)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ValueFailure<$T>.notAlphaNum'))
      ..add(DiagnosticsProperty('failedValue', failedValue));
  }
  ...
  @JsonKey(ignore: true)
  @override
  $NotAlphaNumCopyWith<T, NotAlphaNum<T>> get copyWith =>
      _$NotAlphaNumCopyWithImpl<T, NotAlphaNum<T>>(this, _$identity);
  ...
  TResult when<TResult extends Object>({
    ...
    assert(multiline != null);
    assert(notAlphaNum != null);
    return notAlphaNum(failedValue);
  }
...
abstract class NotAlphaNum<T> implements ValueFailure<T> {
  const factory NotAlphaNum({@required T failedValue}) = _$NotAlphaNum<T>;
